  ...
  return (
    ...
    <div className={`${style.footer} container col-12 text-center p-5`}>
      <div class={`d-flex justify-content-between align-items-center flex-column flex-md-row pb-2 ${style.borderFooter}`}>
        <h4 class="ml-0 ml-md-3 mb-4 mb-sm-2">Astrid TOYS</h4>
      </div>
      <div class="d-flex justify-content-center align-items-center justify-content-md-between flex-column flex-md-row mx-3 mt-2">
        ...
        <Link to={{ pathname:"https://www.linkedin.com/in/maxidf/"}} target="_blank"><li class="nav-item mr-2"><i class="fab fa-linkedin mr-1 ml-2 "></i> Maximiliano De Filippis </li></Link>
        ...
        <Link to={{ pathname:"https://www.linkedin.com/in/nicolas-acevedo-b444a41b2/"}} target="_blank"><li class="nav-item mr-2"><i class="fab fa-linkedin ml-2 mr-1"></i> Nicolás Acevedo </li></Link>
        <Link to={{ pathname:"https://www.linkedin.com/in/rodrigomanuelpenela"}} target="_blank" ><li class="nav-item mr-2"><i class="fab fa-linkedin mr-1 ml-2 "></i> Rodrigo Penela </li></Link>
        </ul>
        </div>
      </div>
    </div>
